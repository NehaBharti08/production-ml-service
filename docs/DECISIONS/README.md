...
| 0003 | Dataset selection — Diabetes 130-US Hospitals | 1 | Pending |
| 0004 | Temporal split on an `encounter_id` proxy | 1 | Pending |
| 0005 | Drift thresholds by empirical null calibration | 6 | Pending |
